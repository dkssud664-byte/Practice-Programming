...
---
**실행 1(성공)**
생각 : 숫자가 아니면 문자열은 담아두고 switch문으로 비교해서 int로 반환해 answer에 더해준다
결과 : 성공
...
public class Solution {
    public int solution(string s) {
            ...
            for (int i = 0; i < s.Length; i++)
            {
                ...
                else if (temp.Length >= 3)
                {
                    for (int j = 0; j < numbers.Length; j++)
                    {
                        ...
                        {
                            answer *= 10;
                            answer += ChangeNumberToString(temp);
                            temp = "";
                            break;
                        }
                    }
        ...
        public int ChangeNumberToString(string str)
        {
            int num = 0;
