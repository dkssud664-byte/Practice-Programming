...
링크 : https://school.programmers.co.kr/learn/challenges/beginner?order=acceptance_desc&languages=csharp&page=2
...
public class Solution {
    public int solution(int slice, int n) {
        ...
        float division = _n / _slice;

        answer = (int)Math.Ceiling(division);
